...
if w in (256,512) and d128 <= -2.0:
    print('DECISION=V56_BOUNDARY_STILL_DESCENDING__PUSH_LARGER_FIXED_CHUNKS_BEFORE_WEIGHTING')
elif w == 128:
    print('DECISION=V56_FIXED_OPTIMUM_BRACKETED_AT_128__ADVANCE_LOAD_BALANCE_CENSUS')
else:
    print('DECISION=V56_FIXED_OPTIMUM_NEAR_128__REPEAT_LOCAL_BRACKET_BEFORE_WEIGHTING')
print('RULE=PUSH_FIXED_POLICY_TO_CLOSURE_BEFORE_CREATING_WORK_WEIGHT_DISTINCTION')
PY
