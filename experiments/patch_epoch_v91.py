...
CANDIDATE='d24138f480225bf2428d3c9b01ba7594d9df2b49'
...
def main(root):
    ...
    t=root/'src/tests.rs'; tb=t.read_bytes(); assert blob(tb)=='2ddc1124db83fee44b2fec9a4b3cb4e5e23f5cfc'
    t.write_text(t.read_text()+'mod epoch_v91;\n')
