...
"""
new="""                    if heads_match {
                        // Flash transfer of the previously verified gap2 scheduler:
...
"""
if c.count(old)!=1:
    raise SystemExit(f"gap2 transfer anchor mismatch: {c.count(old)}")
c=c.replace(old,new,1)
p.write_text(c)
print("QCKN_UNFOLD_GAP2_TRANSFER_V1_PATCH=PASS")
