...
new_extend = "pub fn env_extend<'a>(arena: &'a Bump, parent: E<'a>, v: V<'a>) -> E<'a> {\n    let v_hash = v as *const Value<'a> as usize as u64;\n    let parent_hash = parent.get_hash();\n    let hash = parent_hash.wrapping_mul(0x9E3779B97F4A7C15).wrapping_add(v_hash);\n    let len = parent.len() + 1;\n\n    // One deterministic skip pointer per node.  Its span is the largest power\n    // of two dividing this node's depth.  That gives logarithmic ancestor\n    // navigation while keeping the persistent environment extension small.\n    let jump_dist = len & len.wrapping_neg();\n    let mut jump = parent;\n    let mut remaining = jump_dist - 1;\n    while remaining != 0 {\n        match jump {\n            Env::Cons { parent: jp, jump: jj, jump_dist: jd, .. } if *jd <= remaining => {\n                remaining -= *jd;\n                jump = jj;\n            }\n            Env::Cons { parent: jp, .. } => {\n                remaining -= 1;\n                jump = jp;\n            }\n            Env::Nil { .. } | Env::Framed { .. } => break,\n        }\n    }\n\n    arena.alloc(Env::Cons {\n        v,\n        parent,\n        jump,\n        jump_dist,\n        lsub: parent.lsub(),\n        hash,\n        len,\n        prune: Cell::new((0, None)),\n    })\n}"
